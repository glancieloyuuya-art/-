#!/usr/bin/env python3
# 02_train_logreg_group_split_v2_fixed_threshold.py
# ------------------------------------------------------------
...
# Usage:
#   cd /path/to/out
#   python 02_train_logreg_group_split_v2_fixed_threshold.py
#
# Optional:
#   python 02_train_logreg_group_split_v2_fixed_threshold.py --seed 42 --save_test_pred
# ------------------------------------------------------------
...
def main():
    ...
    log.log(f"[INFO] threshold   : {FIXED_THRESHOLD}")
    ...
    pred_all = (prob_all >= FIXED_THRESHOLD).astype(int)
